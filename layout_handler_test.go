...
func TestLayoutHandler_FormatSpecial(tt *testing.T) {
	...
	tests := []struct {
		...
		{F{"time": "%.v"}, 0, "2006-01-02T15:04:05.789+01:00 level=INFO msg=test"},
		{F{"time": "%.30v"}, 0, "2006-01-02T15:04:05.789+01:00 level=INFO msg=test"},
		{F{"time": "%0.30v"}, 0, "2006-01-02T15:04:05.789+01:00 level=INFO msg=test"},
		{F{"time": "%30v"}, 0, "level=INFO msg=test"},
		{F{"time": "%30.v"}, 0, "level=INFO msg=test"},
		{F{"time": "%30.0v"}, 0, "level=INFO msg=test"},
		{F{"time": "%30.10v"}, 0, "level=INFO msg=test"},
		{F{"time": "%30.50v"}, 0, "level=INFO msg=test"},
		{F{"time": "%.10v"}, 0, "2006-01-02 level=INFO msg=test"},
		{F{"time": "%0.10v"}, 0, "2006-01-02 level=INFO msg=test"},
		{F{"time": "%11v"}, 0, "15:04:05.789+01:00 level=INFO msg=test"},
		{F{"time": "%11.v"}, 0, "15:04:05.789+01:00 level=INFO msg=test"},
		{F{"time": "%11.0v"}, 0, "level=INFO msg=test"},
		{F{"time": "%11.12v"}, 0, "15:04:05.789 level=INFO msg=test"},
		{F{"time": "%11.30v"}, 0, "15:04:05.789+01:00 level=INFO msg=test"},
		{F{"time": "%-.10v"}, 0, "2006-01-02 level=INFO msg=test"},
		{F{"time": "%-0.10v"}, 0, "2006-01-02 level=INFO msg=test"},
		{F{"time": "%-11v"}, 0, "15:04:05.789+01:00 level=INFO msg=test"},
		{F{"time": "%-11.v"}, 0, "15:04:05.789+01:00 level=INFO msg=test"},
